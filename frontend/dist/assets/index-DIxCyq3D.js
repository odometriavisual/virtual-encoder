...
#define LOW_PRECISION`),t}function nS(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Uu?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===R_?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===fn&&(t="SHADOWMAP_TYPE_VSM"),t}function iS(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ui:case Ii:t="ENVMAP_TYPE_CUBE";break;case Ds:t="ENVMAP_TYPE_CUBE_UV";break}return t}function rS(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Ii:t="ENVMAP_MODE_REFRACTION";break}return t}function sS(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Go:t="ENVMAP_BLENDING_MULTIPLY";break;case q_:t="ENVMAP_BLENDING_MIX";break;case Y_:t="ENVMAP_BLENDING_ADD";break}return t}function aS(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function oS(n,t,e,i){const r=n.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=nS(e),c=iS(e),f=rS(e),u=sS(e),h=aS(e),p=YM(e),_=KM(s),v=r.createProgram();let m,d,E=e.glslVersion?"#version "+e.glslVersion+`
