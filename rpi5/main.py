...
def main():
    ...
    '''
        Exemplo de uso do source controller
            source_controller = SourceController(PIN=25) 
            source_controller.turn_on()  -> Liga o raspberrypi zero
            source_controller.turn_off() -> Desliga o raspberrypi zero
    '''
